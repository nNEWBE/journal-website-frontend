          ...
          <div className="relative overflow-hidden bg-[#060e22] p-8 sm:p-10 text-white flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-slate-800">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8 space-y-2.5 border-t border-white/10 pt-6">
                <div className="bg-white/4 border border-white/10 p-3 flex items-center gap-3.5 shadow-2xs hover:bg-white/[0.07] transition-colors">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link
                    ...
                    className="text-[11px] font-semibold text-[#1e40af] hover:text-[#1e3a8a] hover:underline transition-colors"
                  >
                    Forgot Password?
                  </Link>
                </div>
