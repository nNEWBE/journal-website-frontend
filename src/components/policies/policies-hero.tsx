...
export function PoliciesHero() {
  return (
    <section
      aria-label="Editorial Policies Hero"
    ...
    >
      <div className="container-x">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] xl:grid-cols-[1fr_420px] gap-10 lg:gap-14 items-start">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2.5">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-slate-100 text-[#1e40af] text-[10px] font-bold uppercase tracking-[0.16em] border border-slate-200/80">
                ...
                ETHICAL FRAMEWORK & POLICIES
              </span>
              <span className="inline-flex items-center gap-1 text-[11px] font-semibold text-slate-500">
                <Landmark className="h-3.5 w-3.5 text-slate-400" />
                Gono Bishwabidyalay Research Governance
              </span>
            </div>
            ...
            <p className="mt-5 text-sm sm:text-base leading-relaxed text-slate-600 max-w-2xl">
              The <strong className="text-slate-900 font-semibold">Gono Bishwabidyalay Journal of Research</strong> enforces strict COPE-aligned publication ethics, double-blind peer review rigor, complete disclosure standards, and durable open-access stewardship to safeguard scholarly credibility.
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-x-6 gap-y-2.5 text-xs text-slate-600 border-t border-slate-100 pt-5">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-slate-900">COPE-Aligned Practice</span>
              </div>
              <div className="flex items-center gap-2">
                <Globe2 className="h-4 w-4 text-[#1e40af]" />
                <span className="font-semibold text-slate-900">CC BY 4.0 Open Access</span>
              </div>
              <div className="flex items-center gap-2">
                <Archive className="h-4 w-4 text-[#1e40af]" />
                <span className="font-semibold text-slate-900">CrossMark Record Integrity</span>
              </div>
            </div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              >
                <span>Browse Policy Directory</span>
          ...
          {/* Right Column: Policy Framework Specification Card */}
          <div className="bg-slate-50/70 border border-slate-200/90 p-6 sm:p-7">
            ...
            <div className="mt-4 divide-y divide-slate-200/70 text-xs">
              <div className="py-2.5 flex items-center justify-between">
                <span className="text-slate-500 font-medium">Ethics Foundation</span>
                <span className="font-semibold text-slate-900">COPE Core Practices</span>
              </div>
              <div className="py-2.5 flex items-center justify-between">
              ...
              <div className="py-2.5 flex items-center justify-between">
                ...
                <span className="font-mono font-bold text-[#1e40af]">&lt; 15% Similarity Check</span>
              </div>
              <div className="py-2.5 flex items-center justify-between">
                <span className="text-slate-500 font-medium">Licensing Model</span>
                <span className="font-semibold text-slate-900">Creative Commons CC BY 4.0</span>
              </div>
              <div className="py-2.5 flex items-center justify-between">
                <span className="text-slate-500 font-medium">Author Rights</span>
                <span className="font-semibold text-emerald-700">Author Retains Copyright</span>
              </div>
              <div className="py-2.5 flex items-center justify-between">
                <span className="text-slate-500 font-medium">Permanent Record</span>
                <span className="font-semibold text-slate-900">CrossRef DOI & CrossMark</span>
              </div>
            </div>

            <div className="mt-5 pt-4 border-t border-slate-200/80 bg-white p-3.5 border text-[11px] text-slate-600 leading-relaxed">
              <span className="font-bold text-slate-900 block mb-0.5">Ethical Commitment:</span>
              Any suspected research misconduct, fabrication, duplicate submission, or undeclared AI content triggers immediate investigation according to formal COPE flowcharts.
            </div>
          </div>
        </div>
      </div>
